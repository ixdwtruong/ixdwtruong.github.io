...
https://docs.google.com/spreadsheets/d/1fwT_ZEwG2rVKRbONhlvIapXY9fAI4If2/edit?usp=drive_web&ouid=109704624462817830968&rtpof=true

<br>

A skills assessment was done to understand the team’s weaknesses and strengths. Overall, the team has strong design, UI/UX, and ideation skills but lacks in the secondary skills regarding coding, computational media, and 3D modeling. We’ll be utilizing pre-made assets to complete the product and if necessary - Creating our own but in a low-poly format so that it is easy to implement.
...
https://docs.google.com/document/d/1KL2ly8EWb0ffksV8IvckTJ9Xq4XGIkUP/edit?usp=drive_web&ouid=109704624462817830968&rtpof=true
...
https://docs.google.com/spreadsheets/d/1XWh_iB8ueCt2MDBg70UVHBYgdhRtFK_i/edit?usp=drive_web&ouid=109704624462817830968&rtpof=true
...
## Character outlines and how the audience will interact with them

Sephani (Persephone) - Character 1 (First Player)
...
Hydel (Hades) - Character 2 (Non Playable Character)
...
Dionne (Demeter) - Character 3 (Non Playable Character)
...
## Concept artwork, character backgrounds
...
Risk 1: The project scope is ambitious and can fail due to the large amount of work needed to be done. 
...
Risk 2: The possibility that there would be team complications (i.e. team members going missing, not doing work, and etc.)
...
Risk 3: Issues with implementing ideas/features in VR, debugging, and making it work would create long development times which we would not finish the project in time.
