...
For myself, I went and tinkered around with getting the p5 serial stuff to work and expermented with different ways of using the buttons to interact with the sketch.
