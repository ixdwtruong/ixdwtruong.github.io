...
1. Picking one good idea among the many that I had
...
1. Through my research and exploration, I learned that data visualization can interact in many forms. From physical objects, drawings, installations, art, and even digitally. Exploring different aspects of interacting with data visualizations like IBM’s exhibit in New York, gave me inspiration and be unique with my project idea.

<br>

2. As with any project, overcoming the struggles and learning from them was rewarding. After I solved my problems of limiting my idea, everything came into place as I started making my mock-ups and using my data visualizations to create the interactions.
