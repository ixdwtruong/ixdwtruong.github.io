...
<i><span style="font-size:10px;">After trying to get my ultrasonic sensor to work, unfortunately, it was dead on arrival</span></i>
...
<i><span style="font-size:10px;">The box that the Arduino came in didn't work as well as I hoped...</span></i>
...
<i><span style="font-size:10px;">Using the tiny box!</span></i>
...
<i><span style="font-size:10px;">Proposed UI and mock up done by me.</span></i>
...
<i><span style="font-size:10px;">The web UI that Alex built from my mockup.</span></i>
