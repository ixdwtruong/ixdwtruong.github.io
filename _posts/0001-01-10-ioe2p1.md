...
After trying to get my ultrasonic sensor to work, unfortunately, it was dead on arrival
...
The box that the Arduino came in didn't work as well as I hoped...
...
Proposed UI and mock up done by me.
...
The web UI that Alex built from my mockup.
